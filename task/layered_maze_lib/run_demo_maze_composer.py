...
_PIXELS_PER_SQUARE = 2  # Pixels per maze grid square. Should be an even number.
...
def main(_):
    path_dir = os.path.join(
        os.getcwd(), '..', 'stimuli', 'layered_mazes', 'maze_size_14',
        'samples_per_pair_100_v0')
    # composer = maze_composer.MazeComposer(
    composer = maze_composer.MazeComposerStimulusSampler(
        path_dir=path_dir,
