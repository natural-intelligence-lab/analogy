...
_MAX_NUM_OVERLAP=2 # 1 # np.inf # 2 # 1 # np.inf
_MIN_EXIT_DISTANCE = 3 # 0.7/16*3>0.1 # 1 # 0 # 2 # 3  # GRID; if set to zero, no constraint on the exit distance

_DISTRACTOR_NUMBER_TURNS=[0,2]
