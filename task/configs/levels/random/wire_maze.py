...
# for 16 grid
_MIN_NUM_TURNS = [0,0] # [0, 0] #    2 # 0 # 2 # inclusive
_MAX_NUM_TURNS = [3,3] # [3,0] # [5, 3] # 5 # 1 # 3 # 5 # np.inf # 0 # 2 # 6 # 4 # exclusive
# _STEP_NUM_TURNS = 2
...
_MIN_NUM_OVERLAP= 1 # 0 # 1 # 0 # 1
_MAX_NUM_OVERLAP= 1 # 0 # np.inf # 2 # 1 # np.inf # 2 # 1 # np.inf
