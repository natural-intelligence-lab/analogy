...
_GAIN_PATH_PREY = 2.5 # 2 # 3  # 1  # speed gain for path prey
_PATH_PREY_OPACITY = 50
...
_FAKE_PREY_DURATION=0 # 30 # 500ms
...
_STEP_OPACITY_UP = 1 # 10 #      0 # 1 # 2021/9/8 # 1 # 0 # 1 # 2 # 3 # 10  # [0 255] # 2021/9/3
_STEP_OPACITY_DOWN = 10 #     30 # 30 # 40  # [0 255]
_OPACITY_INIT = 20 # 100 #     10 # 100 # 10
_P_DIM_DISTANCE = 0 # 2/3
_DIM_DURATION = 2 # [sec]

# staircase for path prey
_STEP_OPACITY_UP_ = 1 # 10 #      0 # 1 # 2021/9/8 # 1 # 0 # 1 # 2 # 3 # 10  # [0 255] # 2021/9/3
_STEP_OPACITY_DOWN_ = 10 #     5 # 30 # 40  # [0 255]
_OPACITY_INIT_ = 20 # 100 #     10 # 100 # 10
...
class TrialInitialization():
    ...
    def create_agent(self, state):
        ...
        agent = sprite.Sprite(
            x=agent_x0,  #  0.5,
            y=_AGENT_Y, shape='square', aspect_ratio=0.1, scale=_AGENT_SCALE, # 0.1, # aspect_ratio=0.3, scale=0.05,
    ...
    def create_fake_prey(self, state):
        fake_prey = sprite.Sprite(shape='circle', scale=0.03, c0=0, c1=255, c2=0)
...
class Config():
    ...
    def _construct_game_rules(self):
        ...
        phase_foreperiod = gr.Phase(
            ...
            continual_rules=update_motion_steps_path_prey,
        ...
        phase_offline = gr.Phase(
            one_time_rules=[create_agent,set_path_prey_opacity], # ,glue_path_prey], # [disappear_fixation, disappear_screen, create_agent],
